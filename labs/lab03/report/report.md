...
![Листинг программы для отрисовки графика динамики длины очереди в пакетах](image/4.png){#fig:002 width=70%}
...
![График динамики длины очереди](image/3.png){#fig:004 width=70%}
